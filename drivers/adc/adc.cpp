...
ADC_Base_Driver::ErrorCodes ADC_MCU_Driver::init(void) {
...
ADC_Base_Driver::ErrorCodes ADC_MCU_Driver::read_register(const Register reg, uint8_t* value) {
...
ADC_Base_Driver::ErrorCodes ADC_MCU_Driver::write_register(Register reg, uint8_t value) {
...
ADC_Base_Driver::ErrorCodes ADC_MCU_Driver::read_register_mul(const Register start_reg, uint8_t* buf, uint8_t size) {
...
ADC_Base_Driver::ErrorCodes ADC_MCU_Driver::write_register_mul(Register start_reg, uint8_t* values, uint8_t size) {
...
ADC_Base_Driver::ErrorCodes ADC_MCU_Driver::set_channel(ChannelID channel) {
    return write_register(Register::MUXDIF, (uint8_t) channel);
}

ADC_Base_Driver::ErrorCodes ADC_MCU_Driver::data_read(int32_t *result, uint8_t *status) {
