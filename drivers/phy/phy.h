...
#define mdio_read(addr, reg, value_ptr) HAL_ETH_ReadPHYRegister(&heth1, (addr), (reg), (value_ptr))

/**
 * @brief Macro because I did not feel like changing my code
 */

#define mdio_write(addr, reg, value) HAL_ETH_WritePHYRegister(&heth1, (addr), (reg), (uint16_t)(value))
