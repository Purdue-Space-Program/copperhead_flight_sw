...
etl::expected<void, IMU_Base_Driver::ErrorCode> IMU_MCU_Driver::acceleration_write_register(IMU_Accel_Reg reg,
                                                                                            uint8_t value)
{
...
etl::expected<void, IMU_Base_Driver::ErrorCode> IMU_MCU_Driver::acceleration_read_registers(IMU_Accel_Reg starting_reg,
...
etl::expected<IMU_Base_Driver::Acceleration_Vector_mg, IMU_Base_Driver::ErrorCode> IMU_MCU_Driver::get_acceleration(
    void)
{
    uint8_t buf[7] = {0};
